...
function configureHost(host: HTMLElement): void {
  host.setAttribute("data-browser2ide-page-overlay", "");
...
function configureRenderContainer(container: HTMLElement): void {
  container.setAttribute("data-browser2ide-render", "");
...
function configureLayer(
  ...
  layer.setAttribute("data-browser2ide-box", box);
...
function configureLabel(label: HTMLElement): void {
  label.setAttribute("data-browser2ide-label", "");
