  ...
  await Promise.all([
    ...
    writeFile(
      ...
      [
        ...
        '    throw new Error(`Installed Pin-op metadata expected schema 1/protocol 5, found ${metadata.schemaVersion}/${metadata.protocolVersion}`);',
        "  }",
        ...
        "  }",
        '  console.log("INSTALLED_VSIX_PROTOCOL_V5_OK conus-vision.pin-op");',
